    ...
    <section className="pt-20">
      <div className="max-container">
        ...
        <InteractiveGrid
          rows={7}
          cols={8}
          lineColor="rgba(5, 5, 12, 0.1)"
          lineWidth={1}
          className="mt-20 min-h-[980px] sm:min-h-[700px]"
        >
          <div
            data-lang-id="security"
            className="flex flex-col-reverse md:flex-row p-4 h-full items-center justify-center"
          >
            <CryptoAppAnimation />

            <AnimatedSection className="flex flex-col items-center space-y-6 w-full">
              <h2
                className="text-xl rounded-xl 
                        text-emerald-900 font-semibold
                        border-emerald-900
